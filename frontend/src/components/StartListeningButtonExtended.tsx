   ...
   return (
        <div className={`space-y-4 ${className}`}>
            ...
            <div className="flex items-center space-x-2">
                ...
                />
                <label 
                    htmlFor="system-audio-ext" 
                    className="text-sm font-medium leading-none"
                >
                    Записывать звук системы/других участников
                </label>
            </div>
            ...
            <Button
                ...
                `}
            >
                {isListening && <div className="absolute inset-0 bg-white opacity-20 animate-pulse"></div>}
                ...
                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                    {isListening && (
                        <div className="space-y-2">
                            ...
                            {/* Новый статус */}
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-gray-600">Источники звука:</span>
                                <span className="text-blue-600 font-medium">
                                    Микрофон {captureSystemAudio && '+ Система'}
                                </span>
                            </div>
